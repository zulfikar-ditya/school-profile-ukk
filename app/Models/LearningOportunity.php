...
class LearningOportunity extends Model
{
    use HasFactory;
    ...
    {
        return LearningOportunity::orderByDesc('created_at')->paginate(20);
    }
    ...
    {
        return LearningOportunity::where($col, 'like', '%' . $request . '%')->orderByDesc('created_at')->paginate(20);
    }
}
