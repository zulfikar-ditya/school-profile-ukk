        ...
        <div class="grid grid-cols-2 gap-8 py-8 px-6 md:grid-cols-4">
            ...
            <div>
                ...
                <ul>
                    ...
                    <a href="#" target="_blank" rel="noreferrer" class="text-gray-300 hover:underline"></a>
                    <li class="mb-4">
                        <a href="#" target="_blank" rel="noreferrer" class="text-gray-300 hover:underline"></a>
    ...
    <div class="py-6 px-4 bg-gray-700">
        <div class="container mx-auto">
            <div class="md:flex md:items-center md:justify-between">
                <span class="text-sm text-gray-300 sm:text-center text-left">© {{Date('Y')}} <a href="{{url('')}}">{{$school_information->name}}</a>. All Rights Reserved.</span>
                <div class="flex mt-4 space-x-6 sm:justify-center text-left md:mt-0">
